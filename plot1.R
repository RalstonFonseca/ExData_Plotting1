...
## Date         : 24 Aug 2018
## Version      : 1.0
## Description  : This script creates Plot1.png to examine how household energy 
...
# plot a histogram - Plot 1
hist(hpcData_subset$Global_active_power,main = "Global Active Power", 
